 ...
 * #getString(String)} exist for reading columns of type {@link
 * com.google.spanner.v1.TypeCode#string()}; attempting to call those methods for columns of other
 * types will result in an {@code IllegalStateException}. The {@code getTypeName()} methods should
 * only be called for non-{@code NULL} values, otherwise a {@code NullPointerException} is raised;
 * {@link #isNull(int)}/{@link #isNull(String)} can be used to test for {@code NULL}-ness if
 * necessary.
 *
...
public interface RowBase {
   ...
   * com.google.spanner.v1.TypeCode#bool()}.
   */
  ...
  /**
   * Returns the value of a non-{@code NULL} column with type {@link
   * com.google.spanner.v1.TypeCode#int64()}.
   */
  ...
  /**
   * Returns the value of a non-{@code NULL} column with type {@link
   * com.google.spanner.v1.TypeCode#float64()}.
   */
  ...
  /**
   * Returns the value of a non-{@code NULL} column with type {@link
   * com.google.spanner.v1.TypeCode#BYTES}.
   */
  ByteArray getBytes(int columnIndex);

  /**
   * Returns the value of a non-{@code NULL} column with type {@link
   * com.google.spanner.v1.TypeCodebytes()}.
   */
  ByteArray getBytes(String columnName);

  /**
   * Returns the value of a non-{@code NULL} column with type {@link
   * com.google.spanner.v1.TypeCodetimestamp()}.
   */
  ...
  /**
   * Returns the value of a non-{@code NULL} column with type {@link
   * com.google.spanner.v1.TypeCodedate()}.
   */
   ...
   */
  List<Row> getRowList(int columnIndex);

  /**
   * Returns the value of a non-{@code NULL} column with type {@code Type.array(Type.struct(...))}.
   */
  List<Row> getRowList(String columnName);
}
