...
set_logger("com.google.spez.core.WorkStealingHandler", log_level_core)
set_logger("com.google.spez.core.SpannerToAvroRecord", DEBUG)
...
set_logger("io.grpc.netty.shaded.io", WARN)
